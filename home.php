...
<html>
	...
	<body>
		<div id="menu-bar">
			<img src="https://assets.hongkiat.com/uploads/psd-text-svg/logo-example.jpg" id="logo">
			<nav id="nav-bar">
		...
		<div id="head"></div>
		<div id="globe">
			<img src="darkbg.png" id="bg">
			<img src="map.jpg" id="map">
			
			<img src="pin.png" id="p-van" class="pin" onclick="van()">
			<img src="pin.png" id="p-ny" class="pin" onclick="ny()">
			<img src="pin.png" id="p-rio" class="pin" onclick="rio()">
			<img src="pin.png" id="p-par" class="pin" onclick="par()">
			<img src="pin.png" id="p-giz" class="pin" onclick="giz()">
			<img src="pin.png" id="p-dub" class="pin" onclick="dub()">
			<img src="pin.png" id="p-ker" class="pin" onclick="ker()">
			<img src="pin.png" id="p-seo" class="pin" onclick="seo()">
			<img src="pin.png" id="p-tok" class="pin" onclick="tok()">
			<img src="pin.png" id="p-syd" class="pin" onclick="syd()">	
		</div>
		...
		function ny(){
			document.getElementById("desti").value = "New York";
		...
		function rio(){
			document.getElementById("desti").value = "Rio de Janeiro";
